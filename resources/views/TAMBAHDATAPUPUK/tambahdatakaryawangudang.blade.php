...
<div class="row ml-2">
    <div class="card">
        <div class="card-body" style="width: 1170px">
            <form action="/datakaryawangudangtambah" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-2">
                    <label for="ID_Karyawan_Gudang" class="form-label">ID Karyawan Gudang</label>
                    <input type="text" class="form-control" id="ID_Karyawan_Gudang" name="ID_Karyawan_Gudang">
                </div>
                <div class="mb-2">
