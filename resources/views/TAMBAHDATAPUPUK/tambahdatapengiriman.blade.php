...
<div class="row ml-2">
    <div class="card">
        <div class="card-body" style="width: 1170px">
            <form action="{{ route('datapengirimantambah') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-2">
                ...
                <div class="mb-2">
                    ...
                    <select class="form-control" name="ID_Supir" aria-label="Default select example">
                        ...
                        @foreach($tb_pengiriman_supir as $data )
                ...
                <div class="mb-2">
                    ...
                    <select class="form-control" name="Kode_Truk" aria-label="Default select example">
                        ...
                        @foreach($tb_pengiriman_truk as $data )
                        <option value="{{ $data->Kode_Truk }}">{{ $data->Kode_Truk }}</option>
                        @endforeach
                      </select>
                </div>
                <div class="mb-2">
                    ...
                    <select class="form-control" name="No_Antrian" aria-label="Default select example">
                        ...
                        @foreach($tb_pengiriman_outlet as $data )
