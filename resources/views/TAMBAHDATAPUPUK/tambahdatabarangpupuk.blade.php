...
<div class="row ml-2">
    <div class="card">
        <div class="card-body" style="width: 1170px">
            <form action="/datapupuktambah" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-2">
                    <label for="Kode_Jenis_Pupuk" class="form-label">Kode Jenis Pupuk</label>
                    <input type="text" class="form-control" id="Kode_Jenis_Pupuk" name="Kode_Jenis_Pupuk">
                </div>
                <div class="mb-2">
                    <label for="Jenis_Pupuk" class="form-label">Jenis Pupuk</label>
                    <input type="text" class="form-control" name="Jenis_Pupuk">
                </div>
                <div class="mb-2">
                    ...
                    <select class="form-control" name="ID_Pegawai" aria-label="Default select example">
                        ...
                        @foreach($tb_pupuk_pegawai as $data )
                        <option value="{{ $data->ID_Pegawai }}">{{ $data->ID_Pegawai }}</option>
                        @endforeach
                      </select>
                </div>
                <div class="mb-2">
                    ...
                    <select class="form-control" name="Kode_Pupuk_Masuk" aria-label="Default select example">
                        ...
                        @foreach($tb_pupuk_pupukmasuk as $data )
                        <option value="{{ $data->Kode_Pupuk_Masuk }}">{{ $data->Kode_Pupuk_Masuk }}</option>
                        @endforeach
                      </select>
                </div>
                <div class="mb-2">
                    ...
                    <select class="form-control" name="Kode_Gudang" aria-label="Default select example">
                        ...
                        @foreach($tb_pupuk_gudang as $data )
