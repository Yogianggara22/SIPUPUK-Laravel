...
@section('judul')
<h1 class="m-0">Data Truk || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdatatruk">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/datatrukPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            <div class="card-tools">
                                <form action="/datatruk" method="GET">
                            ...
                            <tbody>
                                @foreach ($tb_kendaraan_truk as $truk)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/datatrukedit/{{ $truk->Kode_Truk }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datatrukdelete/{{ $truk->Kode_Truk }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
