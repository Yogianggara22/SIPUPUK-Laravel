...
@section('judul')
<h1 class="m-0">Data Supir Pengirim || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdatasupir">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/datasupirPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            ...
                            <tbody>
                                @foreach ($tb_supir_pengirim as $supir)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/datasupiredit/{{ $supir->ID_Supir }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datasupirdelete/{{ $supir->ID_Supir }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
