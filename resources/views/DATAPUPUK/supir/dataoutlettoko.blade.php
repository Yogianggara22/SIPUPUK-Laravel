...
@section('judul')
<h1 class="m-0">Data Outlet Toko || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdataoutlet">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/dataoutlettokoPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            <div class="card-tools">
                                <form action="/dataoutlet" method="GET">
                            ...
                            <tbody>
                                @foreach ($tb_outlet_toko as $outlet)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/dataoutlettokoedit/{{ $outlet->No_Antrian }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/dataoutletdelete/{{ $outlet->No_Antrian }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
