...
@section('judul')
<h1 class="m-0">Data Pengiriman || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdatapengiriman">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/datapengirimanPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            ...
                            <tbody>
                                @foreach ($tb_pengiriman as $pengiriman)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/datapengirimanedit/{{ $pengiriman->Kode_Pengiriman }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datapengirimandelete/{{ $pengiriman->Kode_Pengiriman }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
