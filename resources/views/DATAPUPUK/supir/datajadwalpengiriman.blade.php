...
@section('judul')
<h1 class="m-0">Data Jadwal Pengiriman || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            <a href="/datajadwalpengirimanPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            <div class="card-tools">
                                <form action="/datajadwal" method="GET">
                            ...
                            <tbody>
                                @foreach ($tb_jadwal_kirim as $jadwal)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/datajadwalpengirimanedit/{{ $jadwal->Kode_Jadwal }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datajadwaldelete/{{ $jadwal->Kode_Jadwal }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
