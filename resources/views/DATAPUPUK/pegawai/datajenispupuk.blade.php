...
@section('judul')
<h1 class="m-0">Data Jenis Pupuk || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdatajenispupuk">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/datajenispupukPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            <div class="card-tools">
                                <form action="/jenis_pupuk" method="GET">
                        ...
                        <table class="table ">
                            ...
                            <tbody>
                                @foreach ($tb_jenispupuk as $jenispupuk)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/datajenispupukedit/{{ $jenispupuk->ID_Pupuk }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datajenispupukdelete/{{ $jenispupuk->ID_Pupuk }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
