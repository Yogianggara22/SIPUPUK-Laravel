...
@section('judul')
<h1 class="m-0">Data Pupuk Keluar || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdatapupukkeluar">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/datapupukkeluarPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            <div class="card-tools">
                                <form action="/pupuk_keluar" method="GET">
                            ...
                            <tbody>
                                @foreach ($tb_pupuk_keluar as $pupukkeluar)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/datapupukkeluaredit/{{ $pupukkeluar->Kode_Pupuk_Keluar }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datapupukkeluardelete/{{ $pupukkeluar->Kode_Pupuk_Keluar }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
