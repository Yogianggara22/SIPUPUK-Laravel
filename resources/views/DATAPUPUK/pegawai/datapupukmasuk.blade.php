...
@section('judul')
<h1 class="m-0">Data Pupuk Masuk || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdatapupukmasuk">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/datapupukmasukPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            <div class="card-tools">
                                <form action="/pupuk_masuk" method="GET">
                            ...
                            <tbody>
                                @foreach ($tb_pupuk_masuk as $pupukmasuk)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/datapupukmasukedit/{{ $pupukmasuk->Kode_Pupuk_Masuk }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datapupukmasukdelete/{{ $pupukmasuk->Kode_Pupuk_Masuk }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
