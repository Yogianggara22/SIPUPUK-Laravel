...
@section('judul')
<h1 class="m-0">Data Pegawai || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdatapegawai">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/datapegawaiPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            ...
                            <tbody>
                                @foreach ($tb_pegawai as $pegawai)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/datapegawaiedit/{{ $pegawai->ID_Pegawai }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datapegawaidelete/{{ $pegawai->ID_Pegawai }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
