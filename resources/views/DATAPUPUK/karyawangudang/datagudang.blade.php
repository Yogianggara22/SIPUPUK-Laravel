...
@section('judul')
<h1 class="m-0">Data Gudang || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdatagudang">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/datagudangPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            <div class="card-tools">
                                <form action="/data_gudang" method="GET">
                            ...
                            <tbody>
                                @foreach ($tb_gudang as $gudang)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/datagudangedit/{{ $gudang->Kode_Gudang }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datagudangdelete/{{ $gudang->Kode_Gudang }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
