...
@section('judul')
<h1 class="m-0">Data Barang Pupuk || SuperAdmin</h1>
@endsection
                ...
                <section class="content">
                    ...
                    <div class="container">
                        <div class="card-header">
                            ...
                            @endif
                            <a href="/tambahdatapupuk">
                                <tr><button type="button" class="btn btn-success btn-sm">Tambah Data</button></tr>
                            </a>
                            <a href="/datapupukPDF"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                                    </ion-icon>
                                </button></a>
                            <div class="card-tools">
                                <form action="/data_pupuk" method="GET">
                            ...
                            <tbody>
                                @foreach ($tb_pupuk as $pupuk)
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/databarangpupukedit/{{ $pupuk->Kode_Jenis_Pupuk }}" type="button" class="btn btn-primary">Ubah</a>
                                        <a href="/datapupukdelete/{{ $pupuk->Kode_Jenis_Pupuk }}" type="button" class="btn btn-danger">Hapus</a>
                                      </td>
                                    </tr>
                                @endforeach
                            </tbody>
